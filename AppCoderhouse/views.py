...
def abuelo(self):
    abuelo=Familia(nombre='Jorge', apellido='Wilchepol', anio_de_nacimiento=str(int(datetime.datetime.now().year)-int(77)), edad=77)
    abuelo.save()
    texto=f'Me llamo{abuelo.nombre} {abuelo.apellido}, tengo {abuelo.edad} y nací en el {abuelo.anio_de_nacimiento}.'
    return HttpResponse(texto)
